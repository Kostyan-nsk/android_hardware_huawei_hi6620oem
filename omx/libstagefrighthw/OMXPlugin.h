...
#ifndef HANTRO_OMX_PLUGIN_H_
#define HANTRO_OMX_PLUGIN_H_
...
namespace android
{
    ...
    struct OMXPlugin:public OMXPluginBase
    {
        OMXPlugin ();
        virtual ~OMXPlugin ();
    ...
    private:
        ...
        DISALLOW_EVIL_CONSTRUCTORS(OMXPlugin);
    };

} // namespace android

#endif // HANTRO_OMX_PLUGIN_H_
