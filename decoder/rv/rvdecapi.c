...
#define RV_DEC_X170_MODE 8 /* TODO: MIKÄ ON HUKAN MODE */
...
RvDecRet RvDecInit(RvDecInst * pDecInst, u32 useVideoFreezeConcealment,
    ...
    u32 numFrameBuffers, DecDpbFlags dpbFlags)
{
...
RvDecRet RvDecGetInfo(RvDecInst decInst, RvDecInfo * pDecInfo)
{
    ...
    pDecInfo->frameWidth = pFrameD->frameWidth;
    pDecInfo->frameHeight = pFrameD->frameHeight;
                           ...
                           RvDecInput * pInput, RvDecOutput * pOutput)
{
    ...
    if (pDecCont->StrmStorage.rprDetected)
    {
        ...
        SetDecRegister(pDecCont->rvRegs, HWIF_PIC_MB_H_EXT,
 ...
 */
    ...
    {
        /* TODO: tarviiko luuppia (ehkä jos useampia slicejä?) */
        do
        {
