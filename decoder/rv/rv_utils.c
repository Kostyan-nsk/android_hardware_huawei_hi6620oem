...
------------------------------------------------------------------------------*/
u32 rv_GetBits(DecContainer * pDecContainer, u32 numBits)
{
    ...
    out = rv_ShowBits32(pDecContainer) >> (32 - numBits);

    if (rv_FlushBits(pDecContainer, numBits) == HANTRO_OK)
    {
        return (out);
    }
    else
...
------------------------------------------------------------------------------*/
u32 rv_ShowBits32(DecContainer * pDecContainer)
{
...
------------------------------------------------------------------------------*/
u32 rv_FlushBits(DecContainer * pDecContainer, u32 numBits)
{
...
------------------------------------------------------------------------------*/
u32 rv_ShowBits(DecContainer * pDecContainer, u32 numBits)
{
