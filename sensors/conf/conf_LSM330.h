...
#define SENSORS_SIGNIFICANT_MOTION_ENABLE		(0) //(1 & OS_VERSION_ENABLE)
...
#define SENSOR_DATANAME_ACCELEROMETER	"acc_input"				// Name of input device: struct input_dev->name
...
#define SENSOR_DATANAME_GYROSCOPE	"gyro_input"				// Name of input device: struct input_dev->name
...
#define SIGN_MOTION_ENABLE_VALUE	0x03					// Value to be passed to enable HW Sign Motion Feature
